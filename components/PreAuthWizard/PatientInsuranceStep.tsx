            ...
            <div className="card-premium space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2">
                        <ValidatedInput
                            label="Full Name"
                            placeholder="As on insurance card"
                            value={patient.patientName ?? ''}
                            onChange={(val) => {
                                onPatientChange({ ...patient, patientName: val });
                                onFieldManual?.('patient.patientName');
                                fieldValidation.validateField('patientName', val, fieldValidators.required);
                            }}
                            onBlur={() => fieldValidation.markTouched('patientName')}
                            isValid={fieldValidation.getFieldState('patientName').isValid}
                            touched={fieldValidation.getFieldState('patientName').touched}
                            error={fieldValidation.getFieldState('patientName').error}
                            required
                        />
                    ...
                    <div>
                        <ValidatedInput
                            ...
                            onChange={(val) => {
                                onPatientChange({ ...patient, age: val ? +val : undefined });
                                onFieldManual?.('patient.age');
                                fieldValidation.validateField('age', val, fieldValidators.age);
                            }}
                            onBlur={() => fieldValidation.markTouched('age')}
                            isValid={fieldValidation.getFieldState('age').isValid}
                            touched={fieldValidation.getFieldState('age').touched}
                            error={fieldValidation.getFieldState('age').error}
                            required
                        />
                    ...
                    <div>
                        <ValidatedInput
                            ...
                            onChange={(val) => {
                                onPatientChange({ ...patient, mobileNumber: val });
                                onFieldManual?.('patient.mobileNumber');
                                fieldValidation.validateField('mobileNumber', val, fieldValidators.mobileNumber);
                            }}
                            onBlur={() => fieldValidation.markTouched('mobileNumber')}
                            isValid={fieldValidation.getFieldState('mobileNumber').isValid}
                            touched={fieldValidation.getFieldState('mobileNumber').touched}
                            error={fieldValidation.getFieldState('mobileNumber').error}
                            required
                        />
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <ValidatedInput
                            ...
                            placeholder="Start typing insurer..."
                            value={insurance.insurerName ?? ''}
                            onChange={(val) => {
                                onInsuranceChange({ ...insurance, insurerName: val });
                                onFieldManual?.('insurance.insurerName');
                                fieldValidation.validateField('insurerName', val, fieldValidators.insurer);
                            }}
                            onBlur={() => fieldValidation.markTouched('insurerName')}
                            isValid={fieldValidation.getFieldState('insurerName').isValid}
                            touched={fieldValidation.getFieldState('insurerName').touched}
                            error={fieldValidation.getFieldState('insurerName').error}
                            required
                        />
                    ...
                    <div>
                        <label className="form-label uppercase tracking-wider text-[9px] mb-1">
                            TPA Name <span className="text-red-500">*</span>
                        </label>
                        <div className="relative">
                            <select
                                ...
                                onChange={e => {
                                    ...
                                    fieldValidation.validateField('tpaName', e.target.value, fieldValidators.tpaName);
                                }}
                                onFocus={() => {
                                    setFocusedField('insurance.tpaName');
                        ...
                        {fieldValidation.getFieldState('tpaName').touched && fieldValidation.getFieldState('tpaName').error && (
                            <p className="text-xs text-red-600 font-medium">{fieldValidation.getFieldState('tpaName').error}</p>
                        )}
                    ...
                    <div>
                        <ValidatedInput
                            ...
                            onChange={(val) => {
                                onInsuranceChange({ ...insurance, policyNumber: val });
                                onFieldManual?.('insurance.policyNumber');
                                fieldValidation.validateField('policyNumber', val, fieldValidators.policyNumber);
                            }}
                            onBlur={() => fieldValidation.markTouched('policyNumber')}
                            isValid={fieldValidation.getFieldState('policyNumber').isValid}
                            touched={fieldValidation.getFieldState('policyNumber').touched}
                            error={fieldValidation.getFieldState('policyNumber').error}
                            required
                        />
